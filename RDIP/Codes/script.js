...
{
button= "  <button id='btn"+k+"' onclick='display(this.id,this.value)' value='"+ele[k]+"'>"+ele[k]+"
</button> ";
spbutton += button + "&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;"
buttoncount += 1;
}
...
button = "  <button id='btn"+c+"' onclick='display(this.id,this.value)' value='"+ele1[c]+"'>"+ele1[c]+"
</button> ";
spbutton += button + "&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;"
buttoncount += 1;
